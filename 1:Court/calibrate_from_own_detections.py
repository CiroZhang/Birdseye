...
# Defaults assume the standard sibling layout (Badminton LLM/Project, .../Dataset/BFMD) --
# override with the BFMD_DATA_ROOT env var if your checkout is laid out differently.
BASE = os.environ.get(
    "BFMD_DATA_ROOT",
    os.path.normpath(os.path.join(_HERE, "..", "..", "Dataset", "BFMD", "BFMD_data")),
)
DET_DIR = os.path.join(_HERE, "monotrack_bfmd_detections")
